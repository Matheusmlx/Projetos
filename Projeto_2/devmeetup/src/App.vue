<template>
  <v-app>
    ...
    <v-toolbar dark class="red darken-4">
      ...
      <v-spacer></v-spacer><!--espaço entre o title e os itens-->
      <v-toolbar-items class="hidden-xs-only"><!--Elementos que nao só envolve o titulo mas por exemplo botões -->
        <v-btn 
        flat 
